...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("plugin/register.html", "<ng-form class='uk-form uk-width-medium-1-1 register_page'>\n  <fieldset>\n    <legend></legend>\n    <div class='uk-form-row'>\n      <div class='uk-width-1-3 uk-float-left'>手机号码</div>\n      <input class='uk-width-2-3' ng-model='current_user.mobile' placeholder='手机号码'>\n    </div>\n    <div class='uk-form-row'>\n      <div class='uk-width-1-3 uk-float-left'>密码</div>\n      <input class='uk-width-2-3' ng-model='current_user.password' placeholder='密码' type='password'>\n    </div>\n    <div class='uk-form-row'>\n      <div class='uk-width-1-3 uk-float-left'>二次密码</div>\n      <input class='uk-width-2-3' ng-model='current_user.password_confirmation' placeholder='密码' type='password'>\n    </div>\n    <div class='uk-form-row'>\n      <button class='uk-button uk-button-success uk-width-3-3' ng-click='register()' type='submit'>注册</button>\n    </div>\n  </fieldset>\n</ng-form>")
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("plugin/remote.html", "<div class='data-channel'>\n  <input id='data_transfer_channel_remote' type='hidden'>\n</div>\n<div class='uk-width-medium-1-1 su_models_header'>\n  <ul class='uk-tab' data-uk-tab='{connect: \"#tabs\"}'>\n    <li>\n      <a ui-sref='attributes'>属性</a>\n    </li>\n    <li>\n      <a ui-sref='local'>本地</a>\n    </li>\n    <li class='uk-active'>\n      <a>远程</a>\n    </li>\n    <li>\n      <a ui-sref='system'>构建中国</a>\n    </li>\n  </ul>\n  <div class='uk-margin-right uk-medium-widht-1-3' id='search_area'>\n    <input class='uk-form-small' name='search'>\n    <span>\n      <i class='uk-icon-user'></i>\n    </span>\n  </div>\n  <ul class='uk-switcher uk-margin' id='tabs'>\n    <li></li>\n    <li></li>\n    <li class='uk-active'>\n      <div class='models su_system_models'>\n        <div class='model_item' ng-repeat='model in remote_models track by model.uuid'>\n          <div class='model_icon'>\n            <img height='50' ng-src='{{model.icon}}' width='40'>\n          </div>\n          <div class='model_details'>\n            <div class='model_name'>\n              <strong>{{model.name}}</strong>\n            </div>\n            <div class='model_desc'>\n              <span class='model_size'>\n                {{model.skp_file_size}}\n              </span>\n              <span class='model_buttons uk-float-right'>\n                <button class='uk-button uk-button-success' ng-click=\"download_from_remote(model.skp_file + '|' + model.icon)\">下载</button>\n                <button class='uk-button uk-button-success' ng-click='delete_remote(model.name, model.uuid)'>删除</button>\n              </span>\n            </div>\n            <div class='model_created_time'>\n              {{model.created_at_normal}}\n            </div>\n          </div>\n        </div>\n      </div>\n    </li>\n    <li></li>\n  </ul>\n</div>")
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("plugin/system.html", "<div class='data-channel'>\n  <input id='data_transfer_channel_system' type='hidden'>\n</div>\n<div class='uk-width-medium-1-1 su_models_header'>\n  <ul class='uk-tab' data-uk-tab='{connect: \"#tabs\"}'>\n    <li>\n      <a ui-sref='attributes'>属性</a>\n    </li>\n    <li>\n      <a ui-sref='local'>本地</a>\n    </li>\n    <li>\n      <a ui-sref='remote'>远程</a>\n    </li>\n    <li class='uk-active'>\n      <a href=''>构建中国</a>\n    </li>\n  </ul>\n  <div class='uk-margin-right uk-medium-widht-1-3' id='search_area'>\n    <input class='uk-form-small' name='search'>\n    <span>\n      <i class='uk-icon-user'></i>\n    </span>\n  </div>\n  <ul class='uk-switcher uk-margin' id='tabs'>\n    <li></li>\n    <li></li>\n    <li></li>\n    <li class='uk-active'>\n      <div class='models su_system_models'>\n        <div class='model_item' ng-repeat='model in system_models track by model.uuid'>\n          <div class='model_icon'>\n            <img height='60' ng-src='{{model.icon}}' width='60'>\n          </div>\n          <div class='model_details'>\n            <div class='model_name'>\n              <strong>{{model.name}}</strong>\n              <span class='folder_name uk-success'>\n                {{model.folder_name}}\n              </span>\n            </div>\n            <div class='model_desc' ng-show='model.skp_file_size'>\n              <span class='model_size'>\n                {{model.skp_file_size}}\n              </span>\n              <span class='model_buttons uk-float-right'>\n                <button class='uk-button uk-button-success' ng-click=\"download_from_system(model.skp_file + '|' + model.icon)\">下载</button>\n              </span>\n            </div>\n            <div class='model_created_time'>\n              {{model.created_at_normal}}\n            </div>\n          </div>\n        </div>\n      </div>\n    </li>\n  </ul>\n</div>")
}]);
...
(function() {
  ...
  building.service('Entity', [
    '$q', '$timeout', function($q, $timeout) {
      var index, mine, remove_entity;
      index = function(scope, page, search, data_transfer_channel) {
        var timeoutFun;
      ...
      mine = function(scope, page, search, data_transfer_channel) {
        var timeoutFun;
        scope.defered = $q.defer();
        scope.resolve_mark = 0;
        scope.reject = function(data) {
      ...
      remove_entity = function(scope, uuid, data_transfer_channel) {
        var timeoutFun;
        scope.defered = $q.defer();
        scope.resolve_mark = 0;
        scope.reject = function(data) {
  ...
  building.controller("Remote", [
    'CurrentUser', '$scope', '$http', '$interval', "Entity", function(CurrentUser, $scope, $http, $interval, Entity) {
      var indexFail, indexSuccess;
      $scope.current_entity = {};
      $scope.remote_models = {};
      $scope.delete_remote = function(model_name, uuid) {
        var deleteFail, deleteSuccess;
        if (confirm("永久删除模型" + model_name + "么?" + uuid)) {
          deleteSuccess = function(data) {
            return $scope.remote_models = data;
          };
          deleteFail = function(data) {};
          return Entity.remove_entity($scope, uuid, 'data_transfer_channel_remote').then(deleteSuccess, deleteFail);
        }
      };
      if (CurrentUser.is_login()) {
        indexSuccess = function(data) {
          return $scope.remote_models = data;
        };
        indexFail = function(data) {
          return $scope.remote_models = [];
        };
        return Entity.mine($scope, "0", "", "data_transfer_channel_remote").then(indexSuccess, indexFail);
      }
    }
  ]);
  ...
  building.controller("System", [
    '$scope', '$http', '$interval', "Entity", function($scope, $http, $interval, Entity) {
      ...
      indexFail = function(data) {
        alert(data);
        return $scope.system_models = [];
      };
      return Entity.index($scope, 0, "", "data_transfer_channel_system").then(indexSuccess, indexFail);
    }
  ]);
